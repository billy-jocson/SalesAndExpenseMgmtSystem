...
import { Wallet, Box } from "@gravity-ui/icons";
import {
  Button,
  DateField,
  DateRangePicker,
      ...
      <div className="flex flex-col shadow-md rounded-[1.75rem] w-full p-7 gap-3 max-h-[calc(100dvh-2rem)] overflow-y-scroll min-h-[calc(100vh-2rem)]">
        ...
        <div className="flex flex-col flex-1">
          {user?.role === "Administrator" ? (
            ...
            /* Centered Supplier Cards Section */
            <div className="flex-1 flex flex-col justify-center items-center my-auto py-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl justify-items-center">
                <DashboardCards
                  icon={Box}
                  status={100}
