    ...
    switch (true) {
        ...
        case $requestMethod === 'GET'
         ...
         case $requestMethod === 'GET' && $path === '/products/categories':
             ...
             break;
         // Keep the legacy Product Manager endpoints used by Dinong-Branch.
         case $requestMethod === 'POST' && $path === '/fetchCategories':
             $response = (new ProductController())->getCategories();
             break;
         case $requestMethod === 'POST' && $path === '/fetchProducts':
             $response = (new ProductController())->getProducts($input);
             break;
         case $requestMethod === 'POST' && $path === '/addProduct':
             $response = (new ProductController())->addProduct($input, $_FILES ?? []);
             break;
         case $requestMethod === 'POST' && $path === '/updateProduct':
             $response = (new ProductController())->updateProduct($input, $_FILES ?? []);
             break;
         case $requestMethod === 'POST' && $path === '/updateSellingPrice':
             $response = (new ProductController())->updateSellingPrice($input);
             break;
         case $requestMethod === 'POST' && $path === '/deleteProduct':
             $response = (new ProductController())->softDelete($input);
             break;
         case $requestMethod === 'POST' && $path === '/restockProduct':
