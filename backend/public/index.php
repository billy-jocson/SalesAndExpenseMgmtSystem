...
switch ($requestUri) {
    ...
    case '/api/supplierProductAnalytics':
        $controller = new DashboardController();
        $response = $controller->getTotalProductCardData($inputData);
        http_response_code(200);
        echo json_encode($response);
        break;
    ...
    case '/api/chartData':
        $controller = new DashboardController();
        $response = $controller->getChartAnalytics($inputData);
        http_response_code(200);
        echo json_encode($response);
        break;
    ...
    case '/api/LineChartData':
        $controller = new DashboardController();
        $response = $controller->getLineChartData($inputData);
        http_response_code(200);
        echo json_encode($response);
        break;
